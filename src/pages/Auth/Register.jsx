...
const Register = () => {
  ...
  const submitHandler = async e => {
    e.preventDefault()
    dispatch(authActions.setLoadingMessage('Signing up...'))

    try {
      const user = await requester.register(name, username, password)

      dispatch(authActions.setLoadingMessage(null))
      dispatch(authActions.registered({userId: user.userId, username}))
